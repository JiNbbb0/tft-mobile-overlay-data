...
Assert-Contains $meta '$canonicalItemIndex = New-TftCanonicalIdIndex' 'Fail-closed cross-source item ID index is missing.'
Assert-Contains $meta 'function Resolve-CanonicalPublicationItemId' 'Fail-closed cross-source item ID resolver is missing.'
Assert-Contains $meta 'AMBIGUOUS_CANONICAL_ITEM_ID' 'Ambiguous item IDs are not blocked.'
Assert-Contains $meta 'UNRESOLVED_CANONICAL_ITEM_ID' 'Unresolved item IDs are not blocked.'
